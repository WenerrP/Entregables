...
/* Esta función se utiliza para localizar la provincia que tuvo el mayor
registro de precipitación pluvial en los últimos 10 años. Escribe además el
...
/* Esta función se utiliza para localizar la provincia que tuvo el menor
registro de lluvias en el último año. Escribe además el registro
correspondiente. */
...
/* Esta función se utiliza para localizar el mes con mayor registro de lluvias
en la provincia 18 en el quinto año. Escribe además el registro
correspondiente. */
