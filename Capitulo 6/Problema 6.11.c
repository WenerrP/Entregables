...
int main(void) 
{
    ...
    /* REN es un arreglo unidimensional de tipo real que se utilizará para
    almacenar el rendimiento anual de los fondos de inversión. */
...
{
    /* La función F1 se utiliza para calcular el rendimiento anual de los fondos
    de inversión. El resultado se almacena en el arreglo unidimensional V. */
    int I;
...
{
    /* Esta función calcula el promedio anualizado de las acciones de los
    diferentes fondos. */
    int I, J;
    float SUM, PRO;
